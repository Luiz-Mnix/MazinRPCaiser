...
public class CollectionTranslatorTest {
	...
	public void test_HashSet() throws Exception {
		...
		Set<Exception> translatedData = (Set<Exception>) translator.translate(data, null);
	...
	public void test_ArrayList() throws Exception {
		...
		data.add(new Exception("baz"));
		data.add(new Exception("zap"));
		List<Exception> translatedData = (List<Exception>) translator.translate(data, null);
	...
	public void test_ArrayBlockingQueue() throws Exception {
		...
		data.add(new Exception("baz"));
		data.add(new Exception("zap"));
		ArrayBlockingQueue<Exception> translatedData = (ArrayBlockingQueue<Exception>) translator.translate(data, null);
	...
	public void test_Stack() throws Exception {
		...
		data.add(new Exception("baz"));
		data.add(new Exception("zap"));
		Stack<Exception> translatedData = (Stack<Exception>) translator.translate(data, null);
