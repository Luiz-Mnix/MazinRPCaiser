...
public class DistributedObjectUtilsTest {
	...
	@Test(expected = IllegalDistributedTypeException.class)
	public void testAssert_NonSerializableBackendInterface() throws Exception {
		// Arrange
	...
	public void testIsTypeMapped_SameTransmissible() throws Exception {
		// Arrange
		final Class<?> type = ITransmissibleStub.class;
	...
	public void testIsTypeMapped_DifferentTransmissible() throws Exception {
		// Arrange
		final Class<?> type = ITransmissibleStub.class;
		final Class<?> type2 = ITransmissibleStub2.class;
	...
	// Transmission
	@Transmissible private interface ITransmissibleStub{}
	@Transmissible private interface ITransmissibleStub2{}
}